...
**ETL (real_data_loader.py):** Standardizes raw 6-lakh datasets [Kaggle Malicious URLs](https://www.kaggle.com/api/v1/datasets/download/sid321axn/malicious-urls-dataset) into a balanced 30k training set (50/50 distribution).
